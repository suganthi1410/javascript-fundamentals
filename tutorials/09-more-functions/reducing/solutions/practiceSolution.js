...
/*
    Use '.reduce()' to calculate the total combined weight of all torpedo crates.
...
/*
    Use '.reduce()' to process the 'sectorHabitationHubs' array of objects.
